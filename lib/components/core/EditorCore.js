...
var _EditorContentEditableDiv2 = _interopRequireDefault(
  _EditorContentEditableDiv
);
...
var EditorCore = (function(_Component) {
  ...
  function EditorCore(props) {
    ...
    var _this = (0, _possibleConstructorReturn3["default"])(
      this,
      (EditorCore.__proto__ || Object.getPrototypeOf(EditorCore)).call(
        this,
        props
      )
    );
        ...
        switch (spanNodes[i].className) {
          ...
          case "emphasis":
            ...
            for (var _c = 0; _c < childSum; _c++) {
              parentNode.insertBefore(
                spanNode.childNodes[_c].cloneNode(),
                nextSibling
              );
            }
            parentNode.removeChild(spanNodes[i]);
    ...
    _this.editorFontBorder = function(state) {
      ...
      _EditorSelection2["default"].addRange(
        startNode,
        startOffset,
        endNode,
        endOffset
    ...
    _this.editorHorizontal = function(editarea, root) {
      ...
      if (
        _EditorSelection2["default"].range &&
        _EditorSelection2["default"].validateRange(
          root,
          _EditorSelection2["default"].range
        )
      ) {
      ...
      _this.refs.image.toggle(function(html) {
        ...
        if (html && html.length > 0) {
          if (
            ...
            if (_EditorSelection2["default"].range.pasteHTML) {
              _EditorSelection2["default"].range.pasteHTML(
                "<p>" + html + "</p>"
              );
            } else {
        ...
        if (latex && latex.length > 0) {
          ...
          if (
            ...
            if (_EditorSelection2["default"].range.pasteHTML) {
              ...
              var span = _EditorDom2["default"].createNodeByTag(
                "span",
  ...
  (0, _createClass3["default"])(EditorCore, [
      ...
      value: function componentDidUpdate() {
        ...
        switch (editorState.icon) {
          ...
          case "cleardoc":
            ...
            setTimeout(function() {
              _this2.setState({
                editorState: (0, _extends3["default"])({}, editorState, {
                  icon: ""
                })
              });
            });
      ...
      value: function handleRangeChange(e) {
        ...
        if (selection && selection.rangeCount > 0) {
          if (editorState.icon == "source") {
            ...
            var parentNode = _EditorSelection2["default"].validateSelection(
              selection
            );
            if (
              parentNode &&
              _EditorDom2["default"].isEditorDom(
                parentNode,
    ...
    },
    {
      ...
      value: function handleToolbarIconClick(e, state) {
        ...
        var offsetPosition = _EditorDom2["default"].getOffsetRootParentPosition(
          target,
          root
        );
    ...
    },
    {
      ...
      value: function setContent(content) {
        ...
        if (content.indexOf("mathquill-embedded-latex") != -1) {
          var _self = this;
          _EditorTimer2["default"].setTimeout(function() {
            var editarea = _reactDom2["default"].findDOMNode(
              _self.refs.editarea
            );
            var elements = editarea.querySelectorAll(
      ...
      value: function renderEditArea() {
        ...
        if (showHtml) {
          ...
          return _react2["default"].createElement(
            _EditorContentEditableDiv2["default"],
            {
              ref: "editarea",
        ...
        return _react2["default"].createElement(
          ...
          (0, _extends3["default"])(
            {
              ...
              id: id,
              className:
                "editor-container editor-default" +
                (className ? " " + className : ""),
          ...
          _react2["default"].createElement(
            ...
            _react2["default"].createElement(_ColorDropdown2["default"], {
              hidden:
                _icons.indexOf("forecolor") == -1 &&
                _icons.indexOf("forecolor"),
              ref: "color"
            }),
            ...
            _react2["default"].createElement(_FontSizeComboBox2["default"], {
              ...
              ref: "fontsize",
              fontsize: this.props.fontSize,
              value: editorState.icons["fontsize"]
            ...
            _react2["default"].createElement(_FontFamilyComboBox2["default"], {
              ...
              ref: "fontfamily",
              fontfamily: this.props.fontFamily,
              value: editorState.icons["fontfamily"]
            ...
            _react2["default"].createElement(_ParagraphComboBox2["default"], {
              ...
              ref: "paragraph",
              paragraph: this.props.paragraph,
              value: editorState.icons["paragraph"]
              ...
              .map(function(ic) {
                ...
                return _react2["default"].createElement(
                  ...
                  (0, _extends3["default"])(
                    ...
                    ic.props,
                    {
                      value: editorState.icons[ic.name]
