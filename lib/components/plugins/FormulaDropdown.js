...
var FormulaDropdown = function (_React$Component) {
  ...
  (0, _createClass3["default"])(FormulaDropdown, [{
    ...
    value: function render() {
      var tabs = [{
        title: "常用公式",
        component: _react2["default"].createElement(FormulaIcons, {
          icons: _EditorConstants.FormulaTypes.commonFormulas,
        ...
        title: "符号",
        component: _react2["default"].createElement(FormulaIcons, {
          icons: _EditorConstants.FormulaTypes.symbolFormulas,
        ...
        title: "字母",
        component: _react2["default"].createElement(FormulaIcons, {
          icons: _EditorConstants.FormulaTypes.arabicFormulas,
